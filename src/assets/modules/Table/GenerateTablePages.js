...
function generateCurrentTable() {
  ...
  if (currentTableFlag === 0) {
    templeteRenderTableCells(dataSummary.Countries, 'TotalConfirmed', generateCellTotalCases);
  } else if (currentTableFlag === 1) {
    templeteRenderTableCells(dataSummary.Countries, 'NewConfirmed', generateCellTotalCases);
  } else if (currentTableFlag === 2) {
    templeteRenderTableCells(dataSummary.Countries, 'TotalConfirmed', generateCellTotalCases);
